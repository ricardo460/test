        ...
        var container = document.getElementById("WebGL-salida");
        ...
        var cuboTextura = new THREE.ImageUtils.loadTexture("../imagenes/crate.gif");
        var cubeMaterial = new THREE.MeshLambertMaterial({ map:cuboTextura,side:THREE.DoubleSide });
